...
| [Invoke Agent Internal](reports/invoke-agent-internal-span.md) | agent-framework, agent-lifecycle, autogen, crewai, google-adk, langchain, openai-agents, pydantic-ai |
